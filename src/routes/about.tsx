    ...
    <div>
      ...
      <section className="bg-surface border-b border-border">
        ...
        <div className="container-page py-16 md:py-24 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="aspect-[4/3] rounded-xl overflow-hidden"><img src={heroImg} alt="Terraced buckwheat farms across the Gilgit-Baltistan mountains" className="h-full w-full object-cover" /></div>
        </div>
      </section>

      <section className="container-page py-16 grid lg:grid-cols-2 gap-10 items-center">
        <div className="aspect-[4/3] rounded-xl overflow-hidden order-2 lg:order-1"><img src={missionImg} alt="Stone-milled buckwheat flour being packed by BachatAtBazaar team" className="h-full w-full object-cover" /></div>
