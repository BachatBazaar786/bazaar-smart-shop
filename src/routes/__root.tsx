...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BachatAtBazaar.pk — Pakistan's Smart Shopping Marketplace" },
      { name: "description", content: "Shop premium Himalayan superfoods, health, electronics and home essentials at smart prices. Nationwide delivery across Pakistan." },
      { name: "author", content: "BachatAtBazaar.pk" },
      { property: "og:title", content: "BachatAtBazaar.pk — Pakistan's Smart Shopping Marketplace" },
      { property: "og:description", content: "Shop Smart. Save More. Live Better. Nationwide delivery across Pakistan." },
